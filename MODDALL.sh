...
"
    ...
    if test $EINGABEZ = "5"
      ...
      airodump-ng -c $WIFICHANNEL --bssid $WIFIBSSID -w /root/Desktop/ $WIFIHACKINTERFACE
fi
fi
if test $EINGABE = "2"   
  then 
...
if test $EINGABE = "10"
    then 
    clear
    echo '  ___  _____ ______  _____  _   ________   ___   _____  _   __                                                 
